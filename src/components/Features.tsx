...
const FEATURE_STYLES = [
  { icon: PieChart,      color: "#14b8a6", bg: "rgb(20 184 166 / 0.08)", border: "rgb(20 184 166 / 0.2)",  iconBg: "rgb(20 184 166 / 0.15)" },
  ...
  { icon: Users,         color: "#2dd4bf", bg: "rgb(45 212 191 / 0.06)", border: "rgb(45 212 191 / 0.2)",  iconBg: "rgb(45 212 191 / 0.12)" },
  { icon: BarChart3,     color: "#14b8a6", bg: "rgb(20 184 166 / 0.08)", border: "rgb(20 184 166 / 0.2)",  iconBg: "rgb(20 184 166 / 0.15)" },
        ...
        <AnimateInView type="up" delay={0}>
          <div className="max-w-2xl mb-16">
            ...
            <h2 className="font-display font-extrabold text-4xl sm:text-5xl text-stone-900 tracking-tight leading-tight mb-4">
              ...
              <span style={{ color: "#14b8a6" }}>{t.features.headingColored}</span>
            </h2>
