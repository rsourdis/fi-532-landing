  ...
  const graph = {
    ...
    "@graph": [
      ...
      },
      {
        ...
        publisher: { "@id": `${SITE_URL}/#organization` },
        description:
          "Household budgeting app for couples, families, and roommates. Automate the 50/30/20 rule, track shared expenses, manage recurring bills, split costs, and get AI-powered spending reports — in real time.",
        featureList: [
          "50/30/20 budget rule automation",
